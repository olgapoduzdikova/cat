...
public class ControllerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setCharacterEncoding("cp1251");  // ensures that user input is interpreted as
        ...
        // if purchase action is called
            ...
            if (cart != null) {
                ...
                String phohe = request.getParameter("phohe");
                ...
                validationErrorFlag = validator.validateForm(name, email, phohe, adress, cityRegion, ccNumber, request);
                ...
                if (validationErrorFlag == true) {
                    ...
                    int orderId = orderManager.placeOrder(name, email, phohe, adress, cityRegion, ccNumber, cart);
